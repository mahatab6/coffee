...
const Hero = () => {
    return (
        <div>
            <div className='lg:py-80 lg:pl-208 py-10 px-5  text-white space-y-4' style={{background: `url(${hero})`, backgroundSize: 'cover', backgroundPosition: 'center',backgroundRepeat: 'no-repeat',}}>
